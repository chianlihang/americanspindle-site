...
<div id="body">
    ...
    <ul>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to American Spindle Technology, LLC</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to American Spindle, accessible from <a href="americanspindle.com" rel="external nofollow noopener" target="_blank">americanspindle.com</a></p>
        </li>
        <li>
    ...
    <ul>
    <li>
    <p>By email: contact@americanspindle.com</p>
    </li>
    <li>
    <p>By visiting this page on our website: <a href="americanspindle/#contact" rel="external nofollow noopener" target="_blank">americanspindle.com/#contact</a></p>
    </li>
    <li>
    <p>By phone number: +1 908-812-2100</p>
    </li>
    </ul>
</div>
